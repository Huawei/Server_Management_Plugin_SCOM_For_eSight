...
namespace CommonUtil
{
    ...
    public class EncryptUtil
    {
        ...
        {
            SaveCurVersion();
            HWLogger.Default.Info("rootFile...");
        ...
        {
            SaveCurVersion();
            HWLogger.Default.Info("InitMainKey...");
        ...
        {
            HWLogger.Default.Info("GetRootKey...");
        ...
        {
            // HwLogger.Default.InfoFormat("EncryptWithKey->enKey={0},val={1}", enKey, val);
            ...
            {
                HWLogger.Default.Error("A Cryptographic error occurred:", e);
            ...
            {
                HWLogger.Default.Error("A FormatException error occurred:", fe);
                if (string.IsNullOrWhiteSpace(val))
                    return "";
                else
                    return val;
        ...
        public static string DecryptWithKey(string enKey, string val)
        {
            try
            {
                ...
                //HwLogger.Default.InfoFormat("DecryptWithKey->enKey={0},val={1},retVal={2}", enKey, val, retVal);
                return retVal;
            }
            catch (CryptographicException e)
            {
        ...
        )
        {
           ...
           */
            ...
            //HwLogger.Default.InfoFormat("32 passPhrase={0},saltValue={1},retVal={2},byteStr={3}", passPhrase, saltValue, retVal, byteStr);
            return retVal;
        }
        ...
        public static string GetRootKeyFromPath(bool isInit)
        {
            ...
            //  HwLogger.Default.Info("plainText..." +Encoding.Unicode.GetBytes(plainText)+":"
            ...
            //HwLogger.Default.Info("trueEnKey..." + trueEnKey);
        ...
        {
            HWLogger.Default.Info("GetMainKeyFromPath...");
        ...
        public static bool IsCompatibleVersion()
        {
            ...
            {
                HWLogger.Default.Info("IsCompatibleVersion=!File.Exists...");
                return false;
            }
            string fVersion = ReadOneLineFromFile(versionFile);
            if (!string.Equals(CoreUtil.GetObjTranNull<string>(fVersion).Trim(), curVersion))
            {
                HWLogger.Default.Info("IsCompatibleVersion=!string.Equals({0},curVersion)...", fVersion);
                return false;
            }
        ...
        {
            HWLogger.Default.Info("ClearAndUpgradeKey...");
